...
<script>
    function konfirmasiHapus(id) {
        ...
        if (konfirmasi) {
            window.location.href = 'pemasok pelanggan/hapus_pelanggan.php?id=' + id + '&confirm=yes';
        } else {
    ...
    <div class="container-wrapper">
        ...
        <div class="content-container">
            ...
            <div class="add-data-container">
                <a class="btn btn-primary" href="pemasok pelanggan/tambah_pelanggan.php">Tambah Data</a>
            </div>
            <table border="1px">
                <tr>
                ...
                <?php while ($data = mysqli_fetch_assoc($hasil)) { ?>
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-primary" href="pemasok pelanggan/ubah_pelanggan.php?id=<?php echo $data['id_pelanggan']; ?>">Ubah</a>
                            <a class="btn btn-primary" href="javascript:void(0);" onclick="konfirmasiHapus(<?php echo $data['id_pelanggan']; ?>)">Hapus</a>
                        </td>
                    </tr>
                <?php } ?>
            </table>
